  ...
  return (
    <div>
      ...
      <section className="py-16 md:py-24 bg-[#F5F7FA]">
        <div className="max-w-350 mx-auto px-4 sm:px-6 lg:px-12">
          <h2 className="text-[28px] md:text-[40px] font-bold text-[#313A41] mb-12 leading-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-10">
            ...
            <div>
              ...
              <p className="text-[#313A41]/85 leading-relaxed">
                We understand that many young people face emotional and psychological challenges that can hinder their growth. We provide access to counselling and emotional support services as holistic approach to youth empowerment.
              </p>
            </div>
          </div>
        </div>
